...
class Header {
    ...
    private Cipher createHeaderCipherWithSharedKey(byte[] sharedSecret, int mode) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, java.security.InvalidKeyException {
    ...
    public byte[] decryptSignedSecureHeader(Key asymmetricKey, byte[] buffer) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException, InvalidKeySpecException, InvalidAlgorithmParameterException, SignatureException, IntegrityException, java.security.InvalidKeyException {
    ...
    public void readHeader(InputStream inputStream, Key asymmetricKey, SignatureHeader signatureHeader) throws IOException, NoSuchAlgorithmException, InvalidKeyException, IntegrityException {
        byte[] buffer;
        ...
        this.signature = signatureHeader.getSignature();
        this.version = signatureHeader.getVersion();
        ...
        this.signedSecureHeaderSize = (short)(
                        ((((short)buffer[2])& 0xFF) << 0) |
                        ((((short)buffer[3])& 0xFF) << 8)
                );
        this.keySize = ((((int)buffer[4]) & 0xFF) << 0) |
                        ((((int)buffer[5]) & 0xFF) << 8) |
